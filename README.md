...
## 📌 Notes
- All identifiers (e.g., `id`) were removed before training to avoid data leakage.
- Label Encoding was applied for binary categoricals, and One-Hot Encoding for multi-class categoricals.
- Missing values were imputed using `SimpleImputer` with mean and most frequent strategies.
- Models were evaluated on both macro and weighted F1-scores to handle class imbalance.
